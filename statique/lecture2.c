	...
	/*switch qui permet d'ouvrir une image en fonction d'un nombre aleatoire entre 1 et 5 */
		switch(nbrAlea)
		{case 1:
		fichier = fopen("/media/groupe-tvp/b919f1b0-9122-4865-a76b-bb6386984916/doc/statique/image1-2", "r");
		fprintf(history," je suis en pause");
		break;
		case 2:
		fichier = fopen("/media/groupe-tvp/b919f1b0-9122-4865-a76b-bb6386984916/doc/statique/image2-2", "r");
		fprintf(history," tetris");
		break;
		case 3:
		fichier = fopen("/media/groupe-tvp/b919f1b0-9122-4865-a76b-bb6386984916/doc/statique/image3-2", "r");
		fprintf(history," start to continue");
		break; 
		case 4:
		fichier = fopen("/media/groupe-tvp/b919f1b0-9122-4865-a76b-bb6386984916/doc/statique/image4-2", "r");
		fprintf(history," psychédélique");
		break;
		case 5:
		fichier = fopen("/media/groupe-tvp/b919f1b0-9122-4865-a76b-bb6386984916/doc/statique/image5-2", "r");
		fprintf(history," jul");
		break;
		default:
		break;
